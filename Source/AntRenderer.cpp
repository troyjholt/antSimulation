...
bool AntRenderer::load(Colony &c)
{
    ...
    for(int j = 0; j < c.colSize; j++)
    {
        ...
        // defining the 4 corners of the "Sprite"
        quad[0].position = c._ants.at(j)->pos - nrm_vec + dir_vec;//sf::Vector2f((c._ants.at(j)->pos - nrm_vec + dir_vec), ((c._ants.at(j)->pos.y - 10));
        quad[1].position = c._ants.at(j)->pos + nrm_vec + dir_vec;//sf::Vector2f((c._ants.at(j)->pos.x + 10), (c._ants.at(j)->pos.y - 10));
        quad[2].position = c._ants.at(j)->pos + nrm_vec - dir_vec;//sf::Vector2f((c._ants.at(j)->pos.x + 10), (c._ants.at(j)->pos.y + 10));
        quad[3].position = c._ants.at(j)->pos - nrm_vec - dir_vec;//sf::Vector2f((c._ants.at(j)->pos.x - 10), (c._ants.at(j)->pos.y + 10));
